...
include(":app:word_scrambler_game")
include(":app:dessert_clicker")
include(":app:cupcake")
include(":app:lotto_viewmodel")
include(":app:lunch_tray")
include(":app:race_tracker")
include(":app:mars_photos")
include(":app:number_guessing_game_ver2")
include(":app:single_photo_viewer_app")
include(":app:president_app")
include(":app:bluetoothscanner")
